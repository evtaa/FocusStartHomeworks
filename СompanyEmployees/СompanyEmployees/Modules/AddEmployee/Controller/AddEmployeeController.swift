...
protocol IAddEmployeeController: UIViewController  {
...
final class AddEmployeeController: UIViewController, ShowAlert {

    // MARK: Properties
    private let presenter: IAddEmployeePresenter
    private var rootView: IAddEmployeeView {
        view as? IAddEmployeeView ?? AddEmployeeView()
    }
    ...
    // MARK: Structures
    struct Dependencies {
        let presenter: IAddEmployeePresenter
    }
    ...
    override func loadView() {
        let newView: IAddEmployeeView = AddEmployeeView()
        view = newView
    ...
    private func configureNavigationBar() {
        title = AppText.titleAddEmployee
...
// MARK: IAddEmployeeController
extension AddEmployeeController: IAddEmployeeController {
    func configure() {
    }
