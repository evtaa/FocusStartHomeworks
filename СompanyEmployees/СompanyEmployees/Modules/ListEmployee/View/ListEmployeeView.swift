...
protocol IListEmployeeView: UIView {
...
final class ListEmployeeView: UIView {
    ...
    private let tableView: UITableView = {
        ...
        tableView.estimatedRowHeight = AppLayout.ListEmployee.tableEstimatedRowHeight
        return tableView
    }()
    ...
    private func configureLayoutView() {
        ...
        NSLayoutConstraint.activate([
            ...
            mainStackView.topAnchor.constraint(equalTo: safeArea.topAnchor,
                                           constant: AppLayout.ListEmployee.topMainStackView),
            mainStackView.leadingAnchor.constraint(equalTo: safeArea.leadingAnchor,
                                               constant: AppLayout.ListEmployee.leadingMainStackView),
            mainStackView.trailingAnchor.constraint(equalTo: safeArea.trailingAnchor,
                                                constant: AppLayout.ListEmployee.trailingMainStackView),
            mainStackView.bottomAnchor.constraint(equalTo: safeArea.bottomAnchor,
                                              constant: AppLayout.ListEmployee.bottomMainStackView)
        ])
    }
}

// MARK: - IListEmployeeView
extension ListEmployeeView: IListEmployeeView {
    func setTableViewDataSource(object : UITableViewDataSource) {
